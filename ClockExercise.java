 ...
 *Title: ClockExercise 
 *Author: Alex Cortes
 *Purpose: ClockExercise reads from the user the current time and a number of minutes
...
public class ClockExercise
{
    ...
    * Assumption #2: The format of the time is 24 hours; the range of possible times are 
      0:0 through 23:59.   
